...
//specificando le key di ogni obj, ad avere il consenso saranno solo le key specificate.
type CountriesCurrency = Record<"france" | "china" | "colombia", Currency>;

const currencies: CountriesCurrency = {
    france: {
        name: "Euro",
        code: "EUR",
        symbol: "€",
